 ...
 * @return C = A + B
 */
matrix* add_m_m(matrix*, matrix*);

/**
 * Calcule la difference entre deux matrices
 * 
 * @param matrix* A la première matrice
 * @param matrix* B la seconde matrice
 * 
